...
function loadSprites()
   ...
   linkdownSword = newAnimation(sworddown,50,50,0.06,8,0,0,false)
   linkrightSword = newAnimation(swordright,50,50,0.06,7,0,0,false)
   linkupSword = newAnimation(sheet,32,40,0.06,7,12,215,false)
